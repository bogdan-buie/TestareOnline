...
export default function ViewQuestions() {
    ...
    return (
        <div className='container'>
            <Link className='btn btn-primary mx-2' to={`/addQuestion`} style={{ margin: '20px' }}>Adauga întrebare</Link>
            <button className='btn btn-success' onClick={() => loadQuestions()} >Refresh</button>
